...
public class RegisterNewCompany extends javax.swing.JDialog {
     ...
     */
    public RegisterNewCompany(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
        ...
        if (CompanyName.isEmpty()) {
            ...
            try {
                 ResultSet resultSet = MYsql.execute("SELECT * FROM `company` "
                         + "INNER JOIN `name` ON `user`.`companyName` = `company`.`Hotline`"
                         + "WHERE `companyName` ='" + CompanyName + "' AND `password` ='" + Hotline + "'");
                        
                  if (resultSet.next()) {
                      
                      HashMap<String,String> map = new HashMap<>();
                      
                      map.put("Companyname", resultSet.getString("Companyname"));
                      map.put("Hotline", resultSet.getString("Hotline"));
...
//                      Company.setVisible(true);
                      ...
                      JOptionPane.showMessageDialog(this, "Invalid companyName or Hotline","Error",JOptionPane.ERROR_MESSAGE);
                      jTextField1.setText("");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                RegisterNewCompany dialog = new RegisterNewCompany(new javax.swing.JFrame(), true);
