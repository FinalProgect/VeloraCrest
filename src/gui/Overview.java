...
public class Overview extends javax.swing.JPanel {
    ...
    private void occupancyGraphic() {
        ...
        jPanel12.setPreferredSize(new Dimension((int) vacantProgress, 100));
        jPanel13.setPreferredSize(new Dimension((int) occupiedProgress, 100));
        jPanel14.setPreferredSize(new Dimension((int) notCleanedProgress, 100));
