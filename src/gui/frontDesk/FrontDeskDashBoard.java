...
//        roundPannels(); /////////////Round veka eka hadanna one//////////////
    ...
    private void loadRoomBooking() {
        RoomsBooking roomsBooking = new RoomsBooking(this);
...
//        logoutIcon.setIcon(logouticon);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        RoomStatusGUIUpdatorRoomsBooking.roomsStatusUpdatingWorkerStarted = false;
        sideBarButtonAnimate(jButton1);
        landPanel.removeAll();
        loadOverview();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
       RoomStatusGUIUpdatorFrantDeskOverView.FrantDeskOvervireRoomsUpdatorStarted = false;
       RoomStatusGUIUpdatorRoomsBooking.roomsStatusUpdatingWorkerStarted = false;
